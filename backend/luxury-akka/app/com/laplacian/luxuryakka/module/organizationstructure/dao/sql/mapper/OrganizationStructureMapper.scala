package com.laplacian.luxuryakka.module.organizationstructure.dao.sql.mapper

import com.laplacian.luxuryakka.module.organizationstructure.domain.{OrganizationStructureDetailsEntity, OrganizationStructureType}
...
object OrganizationStructureMapper
{
  ...
  private final val PARENT_ID                 = "parent_id"
  ...
  class OrganizationStructureDetailsTableDescriptor(tag: Tag) extends Table[OrganizationStructureDetailsEntity](tag, TABLE_NAME)
  {
    ...
    def * = (id, name, entityType, parentId, description, shortDescription)  <>
